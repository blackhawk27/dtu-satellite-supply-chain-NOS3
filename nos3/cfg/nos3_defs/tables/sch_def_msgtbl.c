...
SCH_MessageEntry_t SCH_DefaultMessageTable[SCH_MAX_MESSAGES] = {
    ...
    {{CFE_MAKE_BIG16(SBN_CMD_MID), CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000}}, /* 18 SBN HK */
    ...
    /* Per-component HK requests (sc-mission components) */
    {{CFE_MAKE_BIG16(NOVATEL_OEM615_REQ_HK_MID),     CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000}}, /* 25 GPS HK */
    {{CFE_MAKE_BIG16(GENERIC_RADIO_REQ_HK_MID),      CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000}}, /* 26 RADIO HK */
    {{CFE_MAKE_BIG16(GENERIC_RW_APP_SEND_HK_MID),    CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000}}, /* 27 RW HK */
    {{CFE_MAKE_BIG16(GENERIC_EPS_REQ_HK_MID),        CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000}}, /* 28 EPS HK */
    {{CFE_MAKE_BIG16(GENERIC_STAR_TRACKER_REQ_HK_MID), CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000}}, /* 29 ST HK */
    {{CFE_MAKE_BIG16(GENERIC_ADCS_REQ_HK_MID),       CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000}}, /* 30 ADCS HK */
    {{CFE_MAKE_BIG16(GENERIC_CSS_REQ_HK_MID),        CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000}}, /* 31 CSS HK */
    {{CFE_MAKE_BIG16(GENERIC_FSS_REQ_HK_MID),        CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000}}, /* 32 FSS HK */
    {{CFE_MAKE_BIG16(GENERIC_IMU_REQ_HK_MID),        CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000}}, /* 33 IMU HK */
    {{CFE_MAKE_BIG16(GENERIC_MAG_REQ_HK_MID),        CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000}}, /* 34 MAG HK */
    {{CFE_MAKE_BIG16(GENERIC_TORQUER_REQ_HK_MID),    CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000}}, /* 35 TORQUER HK */
    {{CFE_MAKE_BIG16(MGR_REQ_HK_MID),                CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000}}, /* 36 MGR HK */
    {{CFE_MAKE_BIG16(GENERIC_TT_C_REQ_HK_MID),       CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000}}, /* 37 TT_C HK */
    {{CFE_MAKE_BIG16(GENERIC_GNSS_REQ_HK_MID),       CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000}}, /* 38 GNSS HK */
    {{CFE_MAKE_BIG16(SAMPLE_REQ_HK_MID),             CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000}}, /* 39 SAMPLE HK */
