...
SCH_MessageEntry_t SCH_DefaultMessageTable[SCH_MAX_MESSAGES] = {
    ...
    {{CFE_MAKE_BIG16(GENERIC_EPS_REQ_HK_MID), CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000}}, /* 25 EPS HK */
    {{CFE_MAKE_BIG16(GENERIC_ADCS_REQ_HK_MID), CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000}}, /* Index 26: ADCS HK */
    {{CFE_MAKE_BIG16(CAM_SEND_HK_MID), CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000}},     /* Index 27: CAM HK */
    {{CFE_MAKE_BIG16(GENERIC_RADIO_REQ_HK_MID), CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000}},/* Index 28: RADIO HK */
    ...
    {{CFE_MAKE_BIG16(SCH_UNUSED_MID)}}  /* 127 */ //Lige tilføjet
};
